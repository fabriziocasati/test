...
bool vacant"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_i2dB.pack(_x.docking_station.id, _x.docking_station.x, _x.docking_station.y, _x.docking_station.vacant))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.docking_station.id, _x.docking_station.x, _x.docking_station.y, _x.docking_station.vacant,) = _struct_i2dB.unpack(str[start:end])
