...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_struct_3If.pack(_x.auction, _x.robot, _x.docking_station, _x.bid))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.auction, _x.robot, _x.docking_station, _x.bid,) = _struct_3If.unpack(str[start:end])
      return self
