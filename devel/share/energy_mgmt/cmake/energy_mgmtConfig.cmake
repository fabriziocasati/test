...
if("TRUE" STREQUAL "TRUE")
  set(energy_mgmt_SOURCE_PREFIX /home/fabrizio/ros_indigo_external/src/aau_multi_robot/energy_mgmt)
  set(energy_mgmt_DEVEL_PREFIX /home/fabrizio/ros_indigo_external/devel)
  ...
  set(energy_mgmt_INSTALL_PREFIX /home/fabrizio/ros_indigo_external/install)
...
if(NOT "/home/fabrizio/ros_indigo_external/devel/include;/home/fabrizio/ros_indigo_external/src/aau_multi_robot/energy_mgmt/include " STREQUAL " ")
  set(energy_mgmt_INCLUDE_DIRS "")
  set(_include_dirs "/home/fabrizio/ros_indigo_external/devel/include;/home/fabrizio/ros_indigo_external/src/aau_multi_robot/energy_mgmt/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'energy_mgmt' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Micha Rappaport <micha.rappaport@aau.at>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'energy_mgmt' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/fabrizio/ros_indigo_external/src/aau_multi_robot/energy_mgmt/${idir}'.  Ask the maintainer 'Micha Rappaport <micha.rappaport@aau.at>' to fix it.")
    endif()
...
set(energy_mgmt_EXPORTED_TARGETS "energy_mgmt_generate_messages_cpp;energy_mgmt_generate_messages_lisp;energy_mgmt_generate_messages_py")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${energy_mgmt_dep}_FOUND)
      find_package(${energy_mgmt_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${energy_mgmt_dep} REQUIRED ${depend_list})
  endif()
