...
(cl:defmethod cl:initialize-instance :after ((m <RobotPosition-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'RobotPosition-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name explorer-srv:<RobotPosition-request> is deprecated: use explorer-srv:RobotPosition-request instead.")))

(cl:ensure-generic-function 's-val :lambda-list '(m))
(cl:defmethod s-val ((m <RobotPosition-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader explorer-srv:s-val is deprecated.  Use explorer-srv:s instead.")
  (s m))
...
(cl:defmethod cl:initialize-instance :after ((m <RobotPosition-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'RobotPosition-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name explorer-srv:<RobotPosition-response> is deprecated: use explorer-srv:RobotPosition-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<RobotPosition-response>)))
  ...
  "explorer/RobotPositionResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'RobotPosition-response)))
  "Returns string type for a service object of type 'RobotPosition-response"
  "explorer/RobotPositionResponse")
