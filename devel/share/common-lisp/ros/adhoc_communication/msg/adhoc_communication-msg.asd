...
(defsystem "adhoc_communication-msg"
  ...
  :components ((:file "_package")
    ...
    (:file "EmDockingStation" :depends-on ("_package_EmDockingStation"))
    (:file "_package_EmDockingStation" :depends-on ("_package"))
    ...
    (:file "EmRobot" :depends-on ("_package_EmRobot"))
    (:file "_package_EmRobot" :depends-on ("_package"))
    ...
    (:file "EmAuction" :depends-on ("_package_EmAuction"))
    (:file "_package_EmAuction" :depends-on ("_package"))
  ))